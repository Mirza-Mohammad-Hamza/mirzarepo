...
then
       ...
       echo "Container Name :- $Cname   Imagesname :- $ImageName  Container staus :- $RUNNING"
            ...
            if [ "$RUNNING" == "false" ]
             then
                  ...
                  #This Portion create the new container with the same name as you pass in the Container name
                        ...
                        docker run -d -v /var/lib/jenkins/jobs/Pipeline/workspace/:/var/www/html/:rw -p 8000:80 --name $Cname $ImageName
